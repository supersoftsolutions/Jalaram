                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Edit Wholesale Client
                            
                        </header>
                        <div class="panel-body">
                            <div class="form">
                                <f:form class="cmxform form-horizontal " modelAttribute="data" id="signupForm" method="post" action="update_wholesale_client.html" novalidate="">
                                  <f:hidden path="ID"/>
