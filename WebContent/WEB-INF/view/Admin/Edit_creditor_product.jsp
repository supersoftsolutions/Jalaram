...
<body>
	...
	<section id="main-content">
		...
		<div class="row">
			<div class="col-lg-12">
				<section class="panel">
					<header class="panel-heading"> Edit Creditor(Product) </header>
					<div class="panel-body">
						<div class="form">
							<f:form class="cmxform form-horizontal " modelAttribute="data"
								id="signupForm" method="post"
								action="update_creditor_product.html" novalidate="">
								<f:hidden path="creditorid" />
								...
								<div class="form-group ">
									...
									<div class="col-lg-6">
										<f:input class=" form-control" id="mon" path="address" type="text"
											required="required" />
									</div>
								</div>
								...
								<div class="form-group ">
									...
									<div class="col-lg-6">
										<f:input class=" form-control" id="mon" path="mobile" type="text"
											required="required" />
									</div>
								</div>
								...
								<div class="form-group ">
									...
									<div class="col-lg-6">
										<f:input class=" form-control" id="mon" path="product"
											type="text" readOnly="true" required="required" />
									</div>
								</div>

								<div class="form-group ">
									<label for="mon" class="control-label col-lg-3">
										Rate</label>
									<div class="col-lg-6">
										<f:input class=" form-control" id="mon" path="rate" type="text"
											required="required" />
									</div>
								</div>
