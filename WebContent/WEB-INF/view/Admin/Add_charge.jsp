...
var input = document.getElementById('charges');
                            ...
                            <div class="form">
                                <f:form class="cmxform form-horizontal " modelAttribute="data" id="signupForm" method="post" action="" novalidate="">
     							...
     							<f:select path="" class="custom-select form-control" required="">
                                        ...
                                        <div class="col-lg-6">
                                            <!--  <input class=" form-control" id="address1" name="address1" type="text">-->
     							<f:select path="" class="custom-select form-control" required="" id="name">
                                       ...
                                       <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <f:input class=" form-control" items="${list}" path=""  value="" type="text" id="charges" required="required"/>
                                        </div>
                                    </div>
                                  ...
                                  <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <!--  <input class=" form-control" id="address1" name="address1" type="text">-->
     							<f:select path="" class="custom-select form-control" required="" id="name" >
     							        <f:options items="${plist}" itemLabel="Name" itemValue="Name"/>
                                        ...
                                        <div class="col-lg-6">
                                            <f:input class=" form-control" path=""  value="" type="text" id="charges" required="required"/>
                                        </div>
                                    </div>
