                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <f:form class="cmxform form-horizontal " modelAttribute="data" id="signupForm" method="post" action="insert_row_material.html" novalidate="">
                                     
                                   
                                
                                    
                                    <div class="form-group ">
                                        <label for="mon" class="control-label col-lg-3">Product Name</label>
                                        <div class="col-lg-6">
                                            <f:input class=" form-control" path="Product_name" name="Product_name" type="text" required="required"/>
                                        </div>
                                    </div>
