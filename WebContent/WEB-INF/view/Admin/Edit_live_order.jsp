...
<body>
	...
	<section id="main-content">
		...
		<div class="row">
			<div class="col-lg-12">
				<section class="panel">
					<header class="panel-heading"> Edit order </header>
					<div class="panel-body">
						<div class="form">
							<f:form class="cmxform form-horizontal " modelAttribute="data"
								id="signupForm" method="post"
								action="update_live_order.html" novalidate="">
								<f:hidden path="live_orderid" />
								...
								<div class="form-group ">
									...
									<div class="col-lg-6">
										<f:input class=" form-control" id="caterers_name" path="caterers_name"
											type="text" readOnly="true" required="required" />
									</div>
								</div>
								
								<div class="form-group ">
									<label for="mon" class="control-label col-lg-3">product
										</label>
									<div class="col-lg-6">
										<f:input class=" form-control" id="product" path="product" type="text" readOnly="true"
											required="required" />
									</div>
								</div>
								
								<div class="form-group ">
									<label for="mon" class="control-label col-lg-3">Address
										</label>
									<div class="col-lg-6">
										<f:input class=" form-control" id="address" path="address" type="text" readOnly="true"
											required="required" />
									</div>
								</div>
									...
									<div class="form-group ">
									<label for="mon" class="control-label col-lg-3">Date
										</label>
									<div class="col-lg-6">
										<f:input class=" form-control" id="date" path="date" type="text" readOnly="true"
											required="required" />
									</div>
								</div>
								
									<div class="form-group ">
									<label for="mon" class="control-label col-lg-3">Time
										</label>
									<div class="col-lg-6">
										<f:input class=" form-control" id="product" path="time" type="text" readOnly="true"
											required="required" />
									</div>
								</div>
								...
								<div class="form-group ">
									...
									<div class="col-lg-6">
										<f:input class=" form-control" id="rate" path="rate" type="text" onkeyup="myFunction()"
											required="required" />
									</div>
								</div>
								...
								<div class="form-group ">
									...
									<div class="col-lg-6">
										<f:input class=" form-control" id="total" path="total" type="text" readOnly="true"
											required="required" />
									</div>
								</div>
