...
<body>
	...
	<section id="main-content">
		...
		<div class="row">
			<div class="col-lg-12">
				<section class="panel">
					<header class="panel-heading"> Edit Product Rate </header>
					<div class="panel-body">
						<div class="form">
							<f:form class="cmxform form-horizontal " modelAttribute="data"
								id="signupForm" method="post"
								action="update_product_rate.html" novalidate="">
								<f:hidden path="ID" />
								...
								<div class="form-group ">
									...
									<div class="col-lg-6">
										<f:input class=" form-control" id="name" path="cvo.name"
								...
								<div class="form-group ">
									...
									<div class="col-lg-6">
										<f:input class=" form-control" id="product" path="product"
											type="text" readOnly="true" required="required" />
									</div>
								</div>
