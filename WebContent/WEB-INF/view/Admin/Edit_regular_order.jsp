					...
					<div class="panel-body">
						<div class="form">
							<f:form class="cmxform form-horizontal " modelAttribute="data"
								...
								action="update_regular_order.html" novalidate="">
								...
								<div class="form-group ">
									<label for="mon" class="control-label col-lg-3">Mobile No
										</label>
									<div class="col-lg-6">
										<f:input class=" form-control" id="mobile" path="mobile" type="text" readOnly="true"
											required="required" />
									</div>
								</div>
