...
<body>
	...
	<section id="main-content">
		...
		<div class="row">
			<div class="col-lg-12">
				<section class="panel">
					<header class="panel-heading"> Edit Wholesale Product </header>
					<div class="panel-body">
						<div class="form">
							<f:form class="cmxform form-horizontal " modelAttribute="data"
								id="signupForm" method="post"
								action="update_wholesale_product.html" novalidate="">
								...
								<div class="form-group ">
									...
									<div class="col-lg-6">
										<f:input class=" form-control" id="name" path="wvo.name"
								...
								<div class="form-group ">
									<label for="mon" class="control-label col-lg-3">Mon -
										Sat</label>
									<div class="col-lg-6">
										<f:input class=" form-control" id="mon" path="mon" type="text"
											required="required" />
									</div>
								</div>
								...
								<div class="form-group ">
									...
									<div class="col-lg-6">
										<f:input class=" form-control" id="sun" path="sun" type="text"
											required="required" />
									</div>
								</div>
