                            ...
                            <div class="form">
                                ...
                                <%--     
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <f:input class=" form-control" id="mon" path="wvo.name" itemLabel="ID" itemValue="ID" type="text" readOnly="true" required="required"/>
                                        </div>
                                    </div> 
                            --%>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <f:input class=" form-control" id="mon" path="mon" type="text" required="required"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <f:input class=" form-control" id="sun" path="sun" type="text" required="required"/>
                                        </div>
                                    </div>
