                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <f:form class="cmxform form-horizontal " modelAttribute="data" id="signupForm" method="post" action="insert_account.html" novalidate="">
                                    <div class="form-group ">
                                       ...
                                       <div class="form-group ">
                                        <label for="mon" class="control-label col-lg-3">No</label>
                                        <div class="col-lg-6">
                                            <f:input class=" form-control" path="no" name="no" type="text" required="required"/>
                                        </div>
                                    </div>
                                    
                                       <div class="form-group ">
                                        <label for="mon" class="control-label col-lg-3">Branch Name</label>
                                        <div class="col-lg-6">
                                            <f:input class=" form-control" path="b_name" name="b_name" type="text" required="required"/>
                                        </div>
                                    </div>
                                    
                                    <div class="form-group ">
                                        <label for="mon" class="control-label col-lg-3">IFSC</label>
                                        <div class="col-lg-6">
                                            <f:input class=" form-control" path="iFSC" name="iFSC" type="text" required="required"/>
                                        </div>
                                    </div>
                                    
                                       <div class="form-group ">
                                        <label for="mon" class="control-label col-lg-3">Balance</label>
                                        <div class="col-lg-6">
                                            <f:input class=" form-control" path="balance" name="balance" type="text" required="required"/>
                                        </div>
                                    </div>
