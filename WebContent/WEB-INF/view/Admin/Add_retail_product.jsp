                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <f:form class="cmxform form-horizontal " modelAttribute="data" id="signupForm" method="post" action="insert_retail_product.html" novalidate="">
                                      <div class="form-group ">
                                        ...
                                        <f:select path="rvo.ID" class="custom-select form-control" required="">
                                    <f:options items="${list}" itemLabel="name" itemValue="ID"/>
                                      ...
                                      <div class="form-group ">
                                        <label for="priority" class="control-label col-lg-3">Product</label>
                                        <div class="col-lg-6">
                                            <!--  <input class=" form-control" id="address1" name="address1" type="text">-->
                                            <f:select path="product" class="form-control">
                                    ...
                                    <div class="form-group ">
                                        <label for="mon" class="control-label col-lg-3">Mon - Sat</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="mon" name="mon" type="text" required="required">
                                        </div>
                                    </div>
                                    
                                    <div class="form-group ">
                                        <label for="sun" class="control-label col-lg-3">Sun*</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="sun" name="sun" type="text" required="required">
                                        </div>
                                    </div>
