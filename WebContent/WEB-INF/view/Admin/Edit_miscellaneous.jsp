...
<body>
	...
	<section id="main-content">
		...
		<div class="row">
			<div class="col-lg-12">
				<section class="panel">
					<header class="panel-heading"> Edit Miscellaneous </header>
					<div class="panel-body">
						<div class="form">
							<f:form class="cmxform form-horizontal " modelAttribute="data"
								id="signupForm" method="post"
								action="update_miscellaneous.html" novalidate="">
								<f:hidden path="id" />
								...
								<div class="form-group ">
									<label for="mon" class="control-label col-lg-3">Description
										</label>
									<div class="col-lg-6">
										<f:input class=" form-control" id="description" path="description" type="text"
											required="required" />
									</div>
								</div>
