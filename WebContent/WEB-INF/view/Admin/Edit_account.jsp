					...
					<div class="panel-body">
						<div class="form">
							<f:form class="cmxform form-horizontal " modelAttribute="data"
								...
								<div class="form-group ">
									<label for="mon" class="control-label col-lg-3">No
										</label>
									<div class="col-lg-6">
										<f:input class=" form-control" id="no" path="no" type="text"
											required="required" />
									</div>
								</div>
								
								<div class="form-group ">
									<label for="mon" class="control-label col-lg-3">Branch Name
										</label>
									<div class="col-lg-6">
										<f:input class=" form-control" id="b_name" path="b_name" type="text"
											required="required" />
									</div>
								</div>
								
								<div class="form-group ">
									<label for="mon" class="control-label col-lg-3">IFSC
										</label>
									<div class="col-lg-6">
										<f:input class=" form-control" id="IFSC" path="IFSC" type="text"
											required="required" />
									</div>
								</div>
								
								<div class="form-group ">
									<label for="mon" class="control-label col-lg-3">Balance
										</label>
									<div class="col-lg-6">
										<f:input class=" form-control" id="balance" path="balance" type="text"
											required="required" />
									</div>
								</div>
