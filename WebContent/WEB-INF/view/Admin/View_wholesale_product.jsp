  ...
  <div class="panel panel-default">
   ...
   <!--  <div class="col-sm-5 m-b-xs">
    ...
    <div class="table-responsive">
     ...
     <td height="30px" width="30px"> <a href="edit_wholesale_product.html?id=${x.productid}">Edit/</a> <a href="delete_wholesale_product.html?id=${x.productid}">Delete</a></td> 
