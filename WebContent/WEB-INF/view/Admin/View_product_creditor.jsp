  ...
  <div class="panel panel-default">
   ...
   <!--  <div class="col-sm-5 m-b-xs">
    ...
    <div class="table-responsive">
     ...
     <td height="30px" width="30px"> <a href="edit_creditor_product.html?id=${x.creditorid}">Edit/</a> <a href="delete_creditor_product.html?id=${x.creditorid}">Delete</a></td> 
