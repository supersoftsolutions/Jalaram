                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <f:form class="cmxform form-horizontal " modelAttribute="data" id="signupForm" method="post" action="insert_staff.html" novalidate="">
                                    <div class="form-group ">
                                     ...
                                     <div class="form-group ">
                                        <label for="mon" class="control-label col-lg-3">Salary</label>
                                        <div class="col-lg-6">
                                            <f:input class=" form-control" path="Salary" name="Mobile" type="text" required="required"/>
                                        </div>
                                    </div>
