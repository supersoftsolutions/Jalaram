                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <f:form class="cmxform form-horizontal " modelAttribute="data" id="signupForm" method="post" action="insert_material_purchase.html" novalidate="">
                             ...
                             <div class="form-group ">
								...
								<div class="form-group ">
									<label for="mon" class="control-label col-lg-3">Labour Charges
										</label>
									<div class="col-lg-6">
